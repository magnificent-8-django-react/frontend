            ...
            <Map className="map" center={position} zoom={this.state.zoom}>
                ...
                {this.state.location_permission ?
                    <div>
                        <Marker
                            ...
                            icon={myIcon}
                        > 
                            <Popup className="popFonts">
                                Bitwise Food Truck
                            </Popup>
                        </Marker>
                        <span className="disableLocation" onClick={this.componentDidMount()}>Update Location</span>
                    </div>
                    : 
                    <span className="disableLocation">Location Disabled</span>
                }
                {this.state.locations.map( location => (
                    <Marker 
                        ...
                        icon={myIcon}
                    > 
                        <Popup key={location.id} className="popFonts">
                            {location.truck}
                        </Popup>
                    </Marker>
                ))}
